      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${getVacationTypeBadge(vacation.vacationType)}`}>
              ...
              <div className="flex justify-between">
                ...
                <span className="text-sm font-medium text-gray-900">{calculateDays(vacation.from, vacation.to, vacation.vacationType)}일</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            ...
            <span className={`inline-flex px-4 py-2 text-sm font-medium rounded-full ${getStatusBadge(vacation.vacationRequestStatus)}`}>
