...
const FirstApprovalList = () => {
    ...
    const fetchApprovals = async () => {
        setLoading(true);
        try {
            let url = `/approval-steps/first?page=${currentPage}`;
    ...
    const handleRowClick = (approvalStepId) => {
        ...
        navigate(`/approval/first/${approvalStepId}`);
    };
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            <div className="max-w-7xl mx-auto">
                {/* 페이지 헤더 */}
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-gray-900">1차 결재 요청 목록</h1>
                    <p className="text-gray-600 mt-2">
                        1차 결재가 필요한 휴가 신청 목록을 조회하고 관리할 수 있습니다.
                    </p>
                </div>
...
export default FirstApprovalList;