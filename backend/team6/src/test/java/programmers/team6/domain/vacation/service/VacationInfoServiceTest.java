...
class VacationInfoServiceTest {
	...
	void 휴가총합수정테스트() {
		...
		VacationInfo vacationInfo1 = createVacationInfo(vacationInfoUpdateTotalCountRequest1, VacationInfoUpdateResult.SUCCESS);
		VacationInfo vacationInfo2 = createVacationInfo(vacationInfoUpdateTotalCountRequest2, VacationInfoUpdateResult.SUCCESS);
		...
		verify(vacationInfo2, times(1)).updateTotalCount(vacationInfoUpdateTotalCountRequest2.version(), 13);
	}
	...
	private VacationInfo createVacationInfo(VacationInfoUpdateTotalCountRequest infoDto,
		...
		when(vacationInfo.getMemberId()).thenReturn(1L);
		return vacationInfo;
	}
